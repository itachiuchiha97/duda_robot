...
if __name__ == '__main__':
    ...
    Pos_pub  = rospy.Publisher('imu/HeadingTrue', Pose2D , queue_size=1)
    PosD_pub = rospy.Publisher('imu/HeadingTrue_degree', Pose2D, queue_size=1)
    ...
    D_Compass_declination = rospy.get_param('~declination',1.1999998)* (math.pi/180.0)
    ...
    imu_data = Imu()
    imu_data = Imu(header=rospy.Header(frame_id="imu_link"))
